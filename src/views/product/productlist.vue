    ...
    <div class="productlist">
                    ...
                    <el-row :gutter="20">
                        ...
                        <el-col :span="8">
                            <el-form-item label="销量" prop="soldCount">
                                <el-input-number v-model="formData.soldCount" :min="0" style="width: 100%"
                                    :disabled="true" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                    ...
                    <el-row :gutter="20">
                        ...
                        <el-col :span="8">
                            <el-form-item label="评价数" prop="ratingCount">
                                <el-input-number v-model="formData.ratingCount" :min="0" style="width: 100%"
                                    :disabled="true" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
        ...
        <div class="demo-pagination-block">
            <el-pagination v-model:current-page="currentPage" v-model:page-size="pageSize"
                :page-sizes="[10, 20, 30, 40]" :size="size" :disabled="disabled" background
